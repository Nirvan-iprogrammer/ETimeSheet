...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  ({ width = 190, height = 40, disableLink = false, className, href = '/', sx, isNavMini, ...other }, ref) => {
    ...
    const logo = isNavMini ? (
      <Box alt="logo" component="img" src={`${CONFIG.site.basePath}/logo/logo-single.svg`} width={40} height={40} />
    ) : (
      <Box alt="logo" component="img" src={`${CONFIG.site.basePath}/logo/iProgrammer-logo.webp.svg`} width={width} height={height} />
    );
