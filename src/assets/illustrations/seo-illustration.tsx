...
const WelcomeCard: React.FC<WelcomeCardProps> = ({
  time = "19 May 2025, 10:21 PM",
  onViewTimesheet = () => console.log("View timesheet clicked")
}) => {
  ...
  const clockImageStyle: React.CSSProperties = {
    width: '180px',
    height: '180px',
  };
  ...
  return (
    <Card style={containerStyle} elevation={0}>
      <div style={clockContainerStyle}>
        <img 
          src="../../../public/assets/images/home/Minimalist Clock Icon 1.png"
          alt="Clock" 
        ...
        <Typography
          ...
          style={{
            ...
            borderRadius: '8px',
            padding: '6px 12px',
            backgroundColor: 'rgba(0, 0, 0, 0.4)', // Optional: subtle dark bg for better contrast
          }}
        >
          {time}
        </Typography>
...
//       <image
//         href={`${CONFIG.site.basePath}/assets/illustrations/characters/Frame 2147226666.webp`}
//         height="155"
//         x="312"
//         y="30"
//       />
